        ...
        <View style={styles.audioControls}>
          ...
          >
            ...
            <Text style={styles.audioButtonText}>
              {isSpeaking ? 
                (currentLanguage === 'ja' ? '一時停止' : 'Pause') : 
                (currentLanguage === 'ja' ? '歴史を聞く' : 'Listen to History')
              }
            </Text>
          </Pressable>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.historicalSection}>
            <Text style={styles.sectionTitle}>
              {currentLanguage === 'ja' ? '歴史と背景' : 'History & Background'}
            </Text>
            ...
            {historicalInfo ? (
              ...
              <View style={styles.loadingContainer}>
                ...
                <Text style={styles.loadingText}>
                  {currentLanguage === 'ja' ? '歴史情報を取得中...' : 'Loading historical information...'}
                </Text>
              </View>
            )}
          </View>
          ...
          <View style={styles.infoSection}>
            <Text style={styles.infoTitle}>
              {currentLanguage === 'ja' ? '基本情報' : 'Basic Information'}
            </Text>
          ...
          {spot.images.length > 1 && (
            <View style={styles.additionalImages}>
              <Text style={styles.additionalImagesTitle}>
                {currentLanguage === 'ja' ? 'その他の写真' : 'More Photos'}
              </Text>
